    ...
    <div className="livrosContainer">
      {anuncios ? (
        anuncios.map((anuncio) => (
          <AnuncioCardFav key={anuncio.id_anuncio} anuncio={anuncio} autor={anuncio.autor} tipo={anuncio.estado_livro} endereco={anuncio.endereco} foto={anuncio.foto} cidade = {anuncio.cidade} estado = {anuncio.estado} />
        ))
      ) : (
